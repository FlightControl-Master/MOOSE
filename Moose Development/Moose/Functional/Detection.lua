...
do -- DETECTION_UNITS
  ...
  function DETECTION_UNITS:DetectedItemReportSummary( DetectedItem, AttackGroup, Settings )
    ...
    if DetectedItem then
      ...
      Report:Add( string.format( "Threat: [%s]", string.rep(  "â– ", ThreatLevelA2G ), string.rep(  "â–¡", 10-ThreatLevelA2G ) ) )
...
do -- DETECTION_TYPES
  ...
  function DETECTION_TYPES:DetectedItemReportSummary( DetectedItem, AttackGroup, Settings )
    ...
    if DetectedItem then
      ...
      local Report = REPORT:New()
      Report:Add(DetectedItemID .. ", " .. DetectedItemCoordText)
      Report:Add( string.format( "Threat: [%s%s]", string.rep(  "â– ", ThreatLevelA2G ), string.rep(  "â–¡", 10-ThreatLevelA2G ) ) )
